            ...
            <div className="popup-inner">
                ...
                { childData ? (
                    childData.map(
                        ...
                        <p>{d.name}</p> <button style={{backgroundColor: "dodgerblue", color: "white", borderRadius: 4, borderWidth: "1 px", borderColor: "transparent", fontSize: "12px"}} onClick={()=> props.setDelete(d.id)}>delete</button>
                    </div>
                        )
                        )
                ) : (<p>Test</p>)
